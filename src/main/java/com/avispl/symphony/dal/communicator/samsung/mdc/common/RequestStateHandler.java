 ...
 *
 * Then, {@link #verifyAPIState()} is called after the data processing, and if there are errors - the ResourceNotReachableException is thrown
...
public class RequestStateHandler {
	...
	public void verifyAPIState() {
		...
		throw new ResourceNotReachableException(String.format(Constant.REQUEST_COMMANDS_FAILED, apiSections, errorText));
	}
}
